...
const tempWorkspace = await mkdtemp(join(tmpdir(), "chat-dogfood-real-"));
...
await writeFile(join(tempRepo, ".omt", "smoke-real-summary.json"), JSON.stringify(summary, null, 2));

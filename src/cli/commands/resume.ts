      ...
      JSON.stringify(
        {
          ...
          deliveryPolicy: resume.deliveryPolicy ?? runState.deliveryPolicy,
          reviewerDecision: resume.reviewerDecision ?? runState.reviewerDecision,
          ...
          nextActions: runState.deliveryStatus.nextActions.length > 0 ? runState.deliveryStatus.nextActions : resume.nextActions,
        },
        null,
        2,
      ) + "\n",
